...
def parse_args():
    ...
    parser.add_argument('--resume', type=str, default='YOLO_Trained_3_11_2020_epoch50.params',
...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        # use VOC 2007 and 2012 train as trainning set
        train_dataset = gdata.VOCDetection(
            splits=[(2007, 'trainval'), (2012, 'trainval')])
        # use VOC 2007 test as test set
...
if __name__ == '__main__':
    ...
    im_fname = mx.utils.download('https://raw.githubusercontent.com/zhreshold/' +
    ...
    ax = mx.utils.viz.plot_bbox(img, bounding_boxs[0], scores[0],
